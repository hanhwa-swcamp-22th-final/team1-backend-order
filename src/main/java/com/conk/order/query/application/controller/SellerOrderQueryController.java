...
public class SellerOrderQueryController {
  ...
  public SellerOrderQueryController(
      SellerOrderListQueryService sellerOrderListQueryService,
      SellerOrderDetailQueryService sellerOrderDetailQueryService,
      OrderTrackingQueryService orderTrackingQueryService) {
    this.sellerOrderListQueryService = sellerOrderListQueryService;
    this.sellerOrderDetailQueryService = sellerOrderDetailQueryService;
