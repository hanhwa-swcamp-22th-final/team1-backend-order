...
public class AdminOrderQueryController {
  ...
  public AdminOrderQueryController(AdminOrderQueryService adminOrderQueryService) {
  ...
  public ResponseEntity<ApiResponse<AdminOrderListResponse>> getAdminOrders(
    ...
    return ResponseEntity.ok(ApiResponse.success(adminOrderQueryService.getAdminOrders(query)));
  }
  ...
  public ResponseEntity<ApiResponse<OrderDetailResponse>> getOrderDetail(
    ...
    OrderDetailResponse response = adminOrderQueryService.getOrderDetail(orderId);
