...
public class OutboundStatsQueryServiceTest {
  ...
  void getOutboundStatsReturnsPendingOutboundCount() {
    OrderDashboardQueryService service = createService(TUE, Map.of(
  ...
  void getOutboundStats_weekdayIncrease_returnsTrendUp() {
    OrderDashboardQueryService service = createService(WED, Map.of(
        WED, 5,
        WED.minusDays(1), 3
    ));
  ...
  void getOutboundStats_weekdayDecrease_returnsTrendDown() {
    OrderDashboardQueryService service = createService(THU, Map.of(
        THU, 2,
        THU.minusDays(1), 5
    ));
  ...
  void getOutboundStats_weekdayNoChange_returnsTrendFlat() {
    OrderDashboardQueryService service = createService(
  ...
  void getOutboundStats_monday_comparesToPreviousFriday() {
    ...
    OrderDashboardQueryService service = createService(MON, Map.of(
        MON, 5,
        lastFriday, 2
    ));
  ...
  void getOutboundStats_saturday_returnsTrendNull() {
    OrderDashboardQueryService service = createService(SAT, Map.of(SAT, 3));
  ...
  void getOutboundStats_sunday_returnsTrendNull() {
    OrderDashboardQueryService service = createService(SUN, Map.of(SUN, 7));
  ...
  void getOutboundStats_weekend_stillReturnsPendingOutboundCount() {
    OrderDashboardQueryService service = createService(SAT, Map.of(SAT, 9));
  ...
  private OrderDashboardQueryService createService(
    ...
    return new OrderDashboardQueryService(
        new StubMapper(countsByDate),
        new NoopOrderKpiQueryMapper(),
        clock);
  }
  ...
  private static class NoopOrderKpiQueryMapper implements OrderKpiQueryMapper {

    @Override public int countTotal(OrderKpiQuery query) { return 0; }

    @Override public int countReceived(OrderKpiQuery query) { return 0; }

    @Override public int countAllocated(OrderKpiQuery query) { return 0; }

    @Override public int countOutboundInstructed(OrderKpiQuery query) { return 0; }

    @Override public int countPicking(OrderKpiQuery query) { return 0; }

    @Override public int countPacking(OrderKpiQuery query) { return 0; }

    @Override public int countOutboundPending(OrderKpiQuery query) { return 0; }

    @Override public int countOutboundCompleted(OrderKpiQuery query) { return 0; }

    @Override public int countCanceled(OrderKpiQuery query) { return 0; }
  }
}
